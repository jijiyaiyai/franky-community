...
public class PostScoreRefreshJob implements Job, CommunityConstant {
    ...
    static {
        try {
            epoch = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("2020-02-02 00:00:00");
